...
- (BOOL)isValidTellPhone {
    ...
    NSString *postalRegex = @"(^(0[0-9]{2,3}-)?\\d{6,8})|(1[2-9]\\d{9})";
...
- (BOOL)isMobileNumber{
     ...
     * 4G号段 178
     12         */
    NSString * CM = @"^1(34[0-8]|(3[5-9]|5[0127-9]|7[8]|8[2-478])\\d)\\d{7}$";
    /**
     15         * 中国联通：China Unicom
    ...
    NSString * CU = @"^1(3[0-2]|5[56]|7[6]|8[56])\\d{8}$";
    /**
     20         * 中国电信：China Telecom
     21         * 2G/3G号段（CDMA2000网络）133、153、180、181、189
     * 4G号段 177
     22         */
    NSString * CT = @"^1((33|53|8[019]|7[37])[0-9]|349)\\d{7}$";
    /**
     25         * 虚拟运营商
     26         * 区号：170
     28         */
...
// 字母输入限制
-(BOOL)isJudgePasswordLetter
{
    NSCharacterSet *cs = [[NSCharacterSet characterSetWithCharactersInString:ALPHANUM] invertedSet];
    NSString *filtered = [[self componentsSeparatedByCharactersInSet:cs] componentsJoinedByString:@""];
    BOOL isMatch = [self isEqualToString:filtered];
    return isMatch;
}
/**
 *  是否是门牌号
 */
- (BOOL)isValidHouseNumber
{
    NSString *regex = @"^(\\d{1,6}\\-){2}\\d{1,6}$";
    NSPredicate *pred = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regex];
    BOOL isMatch = [pred evaluateWithObject:self];
    return isMatch;
}
...
//    gif|jpg|jpeg|png|GIF|JPG|PNG
    NSArray *array = @[@"jpg",@"png",@"gif",@"jpeg",@"JPG",@"PNG",@"GIF",@"JPEG",@"Jpeg",@"tiff",@"TIFF",@"tif",@"TIF"];
